...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-r", "--samples_receipt_path",
        help="XML file returned by ENA after registering the samples.",
        type=str
    )
    parser.add_argument(
        "-t", "--template_dir",
    ...
    experiment_path = create_experiment(
        samples_receipt_path=args.samples_receipt_path,
